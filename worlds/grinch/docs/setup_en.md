...
- [BizHawk](https://tasvideos.org/BizHawk/ReleaseHistory) Version 2.9.1 is required to play. Other versions are NOT compatible and may have unintended behavior in 
